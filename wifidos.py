...
discover_access_points = subprocess.Popen(["sudo", "airodump-ng","-w" ,"file","--write-interval", "1","--output-format", "csv", check_wifi_result[0]], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
